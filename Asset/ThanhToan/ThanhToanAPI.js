...
async function CreateDonHang() {
    ...
    try {
        const response = await fetch("https://localhost:44366/api-nguoidung/ControllersDonHang/Create", {
            method: 'POST',
            headers: {
...
async function deleteGioHangAPI() {
    ...
    const url = `https://localhost:44366/api-nguoidung/ControllersGioHang/Delete/${maGioHang}`;
...
async function getMaKhachHang() {
    ...
    const url = `https://localhost:44366/api-nguoidung/ControllersTaiKhoan/Get-MaKhachHang/${taiKhoan}`;
    try {
        const response = await fetch(url, {
            method: 'GET',
            headers: {
