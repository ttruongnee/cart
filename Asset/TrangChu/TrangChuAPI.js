...
function getDataFromAPI() {
    const url = "https://localhost:44366/api-nguoidung/ControllersTruyen/Get-All";
    fetch(url, {
        method: 'GET',
        headers: {
...
function SetFile(fileName, container) {
    const url = `https://localhost:44366/api-nguoidung/ControllersTruyen/get-poster/${fileName}`;
...
function getTruyenByTheLoai(tenTheLoai, callback) {
    ...
    const url = `https://localhost:44366/api-nguoidung/ControllersTruyen/GetTruyenByTheLoai/${tenTheLoai}`;
