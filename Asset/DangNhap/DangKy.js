...
function getEmailKhachHangFromAPI() {
    const url = "https://localhost:44366/api-nguoidung/ControllersTaiKhoan/Get-EmailKhachHang";
    fetch(url, {
        method: 'GET',
        headers: {
...
function getTaiKhoanFromAPI() {
    const url = "https://localhost:44366/api-nguoidung/ControllersTaiKhoan/Get-All";
    fetch(url, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json'
...
document.getElementById('main-form').addEventListener('submit', function (event) {
    ...
    const url = "https://localhost:44366/api-nguoidung/ControllersTaiKhoan/Create";
    fetch(url, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
